...
ReinforceAgent_MLP.py : Simple 2 layer MLP version for discrete array input situations. Tested on [CartPole-v1]

ReinforceAgent_CNN.py : CNN version for discrete tensor input (image treatment). Tested on [MiniGrid-Empty-5x5-v0]
